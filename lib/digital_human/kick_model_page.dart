...
class KickModelPage extends StatefulWidget {
  const KickModelPage({super.key});

  @override
  State<KickModelPage> createState() => _KickModelPageState();
}

class _KickModelPageState extends State<KickModelPage> {
  // 模型路径
  final String modelPath = 'assets/kick.glb';
