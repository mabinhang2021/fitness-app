...
class SwatModelPage extends StatefulWidget {
  const SwatModelPage({super.key});

  @override
  State<SwatModelPage> createState() => _SwatModelPageState();
}

class _SwatModelPageState extends State<SwatModelPage> {
  // 模型路径
  final String modelPath = 'assets/swat.glb';
      ...
      Future.delayed(const Duration(seconds: 1), () {
        ...
        try {
          ...
          // 否则使用默认动画
            ...
            animationName = 'Action.001'; // Swat 模型的默认动画
          }
                ...
                builder: (context) => AlertDialog(
                  ...
                  content: const SingleChildScrollView(
                    child: Text(
                      ...
                      '- 点击"播放动画"开始播放当前选择的动画\n'
                      '- 点击"暂停动画"暂停当前播放的动画\n\n'
                      'Swat 模型已知的动画有：Action.001, Action.003, Action.005',
                    ),
                  ),
                  actions: [
                    TextButton(
