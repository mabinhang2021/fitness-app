...
class OverheadsquatModelPage extends StatefulWidget {
  const OverheadsquatModelPage({super.key});

  @override
  State<OverheadsquatModelPage> createState() => _KickModelPageState();
}

class _KickModelPageState extends State<OverheadsquatModelPage> {
  // 模型路径
  final String modelPath = 'assets/overheadsquat.glb';
